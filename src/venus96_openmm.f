...
C***********************************************************************
     ...
     *RKZ(200),FB(200),N3J(200),N3K(200),N3M(200)
      ...
      COMMON/LENJB/ALJ(200),BLJ(200),CLJ(200),N5J(200),N5K(200),
...
C
  ...
  847 FORMAT(1H ,10X,2HN:,I3,8X,2HJ:,I3)
...
C
      IF (NSELT.EQ.3) CALL BAREXC(DUM1,CA,N,NMA)
C
...
C
      ELSE
         ...
         IF (NSN2.EQ.7.OR.NSN2.EQ.8) GATS=0.0112D0
         CBAR=GAO*(GA-GATS)
 ...
 1010 CONTINUE
      ...
      DO 1 I=1,M
         ...
         IF (J3.NE.K3) THEN
            K2=K3-1
            K1=K2-1
            JK=(NABJ(I)-1)*(2*N-NABJ(I))/2+NABK(I)-NABJ(I)
            T1=Q(K1)-Q(J1)
            T2=Q(K2)-Q(J2)
            T3=Q(K3)-Q(J3)
...
C         PATCHED TO CALCULATE OPENMM POTENTIAL ENERGY
C
      IF (NSN2.NE.0) THEN
C        V=V+PESN2
         CALL OPENMM(I3N, V)
...
C         PATCHED TO CALCULATE PARTIALS OF OPENMM
C
      IF (NSN2.NE.0) THEN
C        CALL VSN2
         CALL DOPENMM(I3N)
...
C
      DO 45 I=1,I3N
         AMAX=0.0D0
         DO 43 J=1,I3N
            IF (DABS(A(I,J)).GE.DABS(AMAX)) AMAX=A(I,J)
   43    CONTINUE
...
C
      ...
      COMMON/CONSTN/C1,C2,C3,C4,C5,C6,C7,PI,HALFPI,TWOPI
      COMMON/SADDLE/EBAR,TBAR,EZERO,NBAR 
      DIMENSION C(3*ND1,3*ND1),QCM(3),VCM(3)
